...
| `baseline_ai_nids_only` | Sections 5.2 and 5.3 (Random Forest performance) |
| `qca_extended_pipeline` | Section 5.3 (QCA-integrated metrics) |
| `ml_dsa_65_standalone` | Section 4.6 (PQC implementation) |
| `urllc_compliance` | Section 5.3 (Framework verdict) |
| `noise_resilience` | Appendix B.2 (Noise reliability) |
| `scalability_test` | Appendix B.1 (Scalability) |
| `rf_vs_xgboost_comparison` | Appendix C (Algorithm selection) |
## Dataset Source
